...
@Component({
  selector: 'app-estadisticas-miembros',
  templateUrl: './estadisticas-miembros.page.html',
  styleUrls: ['./estadisticas-miembros.page.scss'],
})
export class EstadisticasMiembrosPage implements OnInit {
  usuario: string;
  codigo: string;
  rol: string;
  nombre: string;
