...
@Component({
  selector: 'app-resultado-partido-baloncesto',
  templateUrl: './resultado-partido-baloncesto.page.html',
  styleUrls: ['./resultado-partido-baloncesto.page.scss'],
})
export class ResultadoPartidoBaloncestoPage implements OnInit {
  usuario: string;
  codigo: string;
  entreno: string;
  mensaje: string;
