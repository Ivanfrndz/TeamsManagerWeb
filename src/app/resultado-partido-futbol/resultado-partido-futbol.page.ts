...
@Component({
  selector: 'app-resultado-partido-futbol',
  templateUrl: './resultado-partido-futbol.page.html',
  styleUrls: ['./resultado-partido-futbol.page.scss'],
})
export class ResultadoPartidoFutbolPage implements OnInit {
  usuario: string;
  codigo: string;
  entreno: string;
  mensaje: string;
