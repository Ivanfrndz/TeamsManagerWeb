...
@Component({
  selector: 'app-resultado-entrenamiento',
  templateUrl: './resultado-entrenamiento.page.html',
  styleUrls: ['./resultado-entrenamiento.page.scss'],
})
export class ResultadoEntrenamientoPage implements OnInit {
  ...
  finalizar(resumen){  
    if (resumen == undefined) {
      ...
      this.firestoreService.finalizarEntreno("equipos", this.codigo, "Entrenamientos", this.entreno, resumen);
      this.router.navigate(['/entrenamiento', {usuario: this.usuario, "codigo": this.codigo, "entreno": this.entreno}]);
    }
  }
